...
Also, **BE** authentication might not be very difficult: they may just share a common secret and use it directly to authenticate, especially when **JF** and **BE** are in the same internal network, which will be a common case.
