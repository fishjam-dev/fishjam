...
hosts = ConfigParser.parse_nodes(System.get_env("NODES", ""))
...
port =
  case System.get_env("PORT") do
    ...
    nil -> 5002
    other -> ConfigParser.parse_port(other, "PORT")
  end
...
config :jellyfish,
  ...
  integrated_turn_port_range:
    ...
    |> ConfigParser.parse_port_range("INTEGRATED_TURN_PORT_RANGE"),
  integrated_turn_tcp_port:
    System.get_env("INTEGRATED_TURN_TCP_PORT")
    |> ConfigParser.parse_port("INTEGRATED_TURN_TCP_PORT"),
  jwt_max_age: 24 * 3600,
  ...
  metrics_port: System.get_env("METRICS_PORT", "9568") |> ConfigParser.parse_port("METRICS_PORT")
