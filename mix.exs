  ...
  defp deps do
    [
      ...
      {:membrane_rtc_engine,
       ...
       override: true,
       branch: "broadcasting/remote_endpoint",
       sparse: "engine"},
      ...
      {:membrane_rtc_engine_hls,
       github: "jellyfish-dev/membrane_rtc_engine", override: true, branch: "broadcasting/remote_endpoint", sparse: "hls"},
      {:membrane_rtc_engine_rtsp,
       github: "jellyfish-dev/membrane_rtc_engine", override: true, branch: "broadcasting/remote_endpoint", sparse: "rtsp"},
      {:membrane_rtc_engine_remote,
       github: "jellyfish-dev/membrane_rtc_engine",
       override: true,
       branch: "broadcasting/remote_endpoint",
       sparse: "remote"},
