  ...
  defp deps do
    [
      ...
      {:membrane_rtc_engine_hls,
       github: "jellyfish-dev/membrane_rtc_engine", override: true, ref: "4ee2541", sparse: "hls"},
      {:membrane_rtc_engine_rtsp,
       github: "jellyfish-dev/membrane_rtc_engine", override: true, ref: "4ee2541", sparse: "rtsp"},
